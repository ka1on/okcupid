...
# The list of valid sexes
sexes <<- list(unique(profiles_df$sex))

# Using "memoise" to automatically cache the results
getTermMatrix <- memoise(function(sex) {
  
  words <- profiles$essay0[profiles$sex == sex]
...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      selectInput("selection", "Choose a Gender:",
                  choices = unique(profiles_df$sex)),
    ...
    mainPanel( 
      tabsetPanel(id = "tabs",
                  ...
                  tabPanel("Graphs", plotOutput("top_10")),
